...
void Deferred::DeferredPasses()
{
	...
	if (Atmosphere::GetSingleton()->loaded) {
		auto MultiScatteringLutSRV = Atmosphere::GetSingleton()->MultiScatteringLutSRV;
		context->CSSetShaderResources(12, 1, &MultiScatteringLutSRV);
	}
