...
#		endif
	...
	float dirLightAngle = dot(worldNormal.xyz, -ClampSunDirection.xyz);
	...
	directionalAmbientColor = (specularTexture.SampleLevel(SampDiffuse, worldNormal, 9).xyz) * PI * SkyLightIntensity;
...
#		endif
	...
	psout.Albedo.w = 1;
	psout.Albedo.xyz = SampleAerialPerspectiveLut(input.WorldPosition.xyz, psout.Albedo.xyz, SampDiffuse);
#	endif
